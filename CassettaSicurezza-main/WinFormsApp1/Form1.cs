 namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        bool editPin=false; //seleziona modalit?di modifica del pin
        ...
        private void confermabtn_Click(object sender, EventArgs e)
        {
            ...
            if (PIN.Length == limitePW)
            {
                if (editPin)
                {
                    if(temp=="") //significa che non ?ancora stato inserito il codice di sblocco
                    {
                        temp = PIN;
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            if (PIN.Length < limitePW)
                ...
                MessageBox.Show("Un oggetto ?gi?contenuto");
            else
            {
        ...
        private void buttoneditPIN_Click(object sender, EventArgs e)
        {
            editPin=true;
            UpdateForm();
            MessageBox.Show("Immetti il codice di sblocco (non ?il PIN)", "Modifica PIN");
